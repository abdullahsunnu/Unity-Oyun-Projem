...
public class GameManager : MonoBehaviour
{
    ...
    YildizYonetim yildizYonetim;

    ToplamaPanel toplamaPanel;
    CikarmaPanel cikarmaPanel;
    Carpma carpma;
    Bolme bolme;
    ...
    private void Awake()
    {
        ...
        yildizYonetim = Object.FindObjectOfType<YildizYonetim>();

        toplamaPanel = Object.FindObjectOfType<ToplamaPanel>();
        cikarmaPanel = Object.FindObjectOfType<CikarmaPanel>();
        carpma = Object.FindObjectOfType<Carpma>();
        bolme = Object.FindObjectOfType<Bolme>();
    ...
    void BirinciFonksiyon()
    {
        ...
        bolme.BolmeScaleKapat();
        carpma.CarpmaScaleKapat();
        cikarmaPanel.CikarmaScaleKapat();
        toplamaPanel.ToplamaScaleKapat();
    ...
    void IkinciFonksiyon()
    {
        ...
        yildizYonetim.yildizAcık(true);



        toplamaPanel.ToplamaScaleAc(oyunSayac % 5);
    ...
    void UcuncuFonksiyon()
    {
        ...
        cikarmaPanel.CikarmaScaleAc(oyunSayac % 5);
        toplamaPanel.ToplamaScaleKapat();
        carpma.CarpmaScaleKapat();
        bolme.BolmeScaleKapat();
        dairelerManager.DairelerinScaleKapat();
    ...
    void DorduncuFonksiyon()
    {
        ...
        cikarmaPanel.CikarmaScaleKapat();
        bolme.BolmeScaleKapat();
        carpma.CarpmaScaleAc(oyunSayac % 5);
        dairelerManager.DairelerinScaleKapat();
    ...
    void BesinciFonksiyon()
    {
        ...
        carpma.CarpmaScaleKapat();
        bolme.BolmeScaleAc(oyunSayac % 5);
        cikarmaPanel.CikarmaScaleKapat();
        dairelerManager.DairelerinScaleKapat();
        toplamaPanel.ToplamaScaleKapat();
    ...
    public void ButonDegeriniBelirle(string butonAdi)
    {
        ...
        {
            yildizYonetim.yildizAcık(false);
